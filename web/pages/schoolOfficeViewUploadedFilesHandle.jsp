    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="schoolOfficeViewUploadedFiles.jsp">View Uploaded Files</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
            ...
            <div id="page-wrapper">
                ...
                <a href="upload_files/<%=path%>"> download</a></br></br>

                <a href="schoolOfficeViewUploadedFiles.jsp"> GO BACK</a></br>
