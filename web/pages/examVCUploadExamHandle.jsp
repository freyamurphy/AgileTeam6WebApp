    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="examVCDashboard.html">Exam Workflow Management System</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
               ...
               <div style="margin: auto; width: 95%;">
                    ...
                    *The file name should be like: YEAR_MODULECODE_TYPEOFEXAM.pdf
                    </br>
                    *Example: 2018-2019_AC31012_mainExam.pdf
                    </br>
                    <form action="uploadhandle.jsp?code=EVC&folder=<%=request.getParameter("module")%>" method="post" enctype="multipart/form-data"></br>
