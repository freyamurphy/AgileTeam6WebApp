        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="externalExaminerDashboard.jsp">Exam Workflow Management System</a>
                </div>
                <!-- /.navbar-header -->
            ...
            <div id="page-wrapper">
                ...
                <form action="externalExaminerViewUploadedFilesHandle.jsp" method="post"></br>
                    <select name="ExamNo">
                        <sql:query dataSource="${connection}" var="result">
                            SELECT * FROM Exams WHERE ExternalExaminer = ? ORDER BY ModuleCode, AcademicYear, ModuleName
