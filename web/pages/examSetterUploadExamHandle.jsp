            ...
            <div class="row">
               ...
               <div style="margin: auto; width: 95%;">
                    ...
                    *Example: 2018-2019_AC31012_mainExam.pdf
                    ...
                    <form action="uploadhandle.jsp?code=ES&folder=<%=request.getParameter("module")%>" method="post" enctype="multipart/form-data"></br>
                    <input type="file" name="file" size="50" /></br>
                    <input type="submit" value="submit" /></br>
                    </form>
                    </br>
                    <a href="examSetterUploadExam.jsp">GO BACK</a>
                </div>
